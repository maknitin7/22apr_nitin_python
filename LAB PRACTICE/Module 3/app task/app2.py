...
class MenuBarApp:
    def __init__(self, root):
        ...
        self.icon_image = tk.PhotoImage("C:\Users\ASUS TUFF\OneDrive\Desktop\22apr_nitin_python\LAB PRACTICE\Module 3\app task\photo.png")
        self.root.imagephoto(False, self.icon_image)
